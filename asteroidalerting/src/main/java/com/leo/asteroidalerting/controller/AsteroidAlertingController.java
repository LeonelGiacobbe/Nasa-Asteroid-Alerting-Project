package com.leo.asteroidalerting.controller;

import com.leo.asteroidalerting.service.AsteroidAlertingService;
...
public class AsteroidAlertingController {
    ...
    // Declare it as final so it is immutable, but inject it in constructor
